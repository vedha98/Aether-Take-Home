...
export class Building {
    constructor(scene, ground, height = 10, footprint = []) {
        this.ground = ground;
        this.scene = scene;
        this.buildingGroup = this.createBuildingGeometry(footprint, height, ground);
    }
    addToScene() {
        this.scene.add(this.buildingGroup);
    }
    createBuildingGeometry(points, height, groundPlane) {
